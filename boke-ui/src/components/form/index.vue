...
<template>
  <div class="boke-form">
    ...
    >
      <div class="boke-form__item-container" :class="[vertical && 'vertical']">
        <template v-for="column in columns" :key="column.prop">
          ...
          >
            ...
            <component
              ...
              :style="{
                width: column?.formProp?.width + 'px',
              }"
              v-bind="column.formProp"
      ...
      <div class="boke-form__item-btn">
        <slot name="formCustom"></slot>
      </div>
      <!-- 表单最后按钮 -->
      <div class="boke-form__actions" v-if="columns?.length > 3">
        <slot name="formFooter"></slot>
      </div>
    </el-form>
  </div>
...
<script setup>
// todo 将每一个form的子组件做一层封装
import { ref, toRefs, useSlots, watchEffect, isRef } from 'vue';
// import { ElSelect, ElDatePicker, ElInput } from 'element-plus';
